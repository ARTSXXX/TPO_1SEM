...
namespace Lb_11.Pages
{
    internal class SearchResultPage : PageBase.PageBase
    {
        ...
        {
            Driver.FindElement(By.XPath("//*[@id=\"paginatorContent\"]/div/div/div[1]/div/div[2]/div/div/button")).Click();
            Info("Product liked.");
        }
        ...
        {
            Driver.FindElement(By.XPath("//*[@id=\"layoutPage\"]/div[1]/div[3]/div/div[1]/div/div[2]/div[2]/div[2]/div/div/button")).Click();
        ...
        {
            Driver.FindElement(By.XPath("//*[@id=\"paginatorContent\"]/div/div/div[1]/div/a")).Click();
            Info("Go to product.");
        }
